(function () {
    ...
    // For simplicity, we'll assume the primary color is bright enough for black text, or allow override if needed.
    // Ideally, we might want a contrast checker, but for now let's stick to black on primary.
    ...
    const css = `
        ...
        #quasar-chat-send { background: ${primaryColor}; border: none; padding: 8px 15px; border-radius: 6px; cursor: pointer; font-weight: bold; color: ${primaryTextColor}; }
